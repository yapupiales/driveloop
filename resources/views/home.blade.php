<x-app-layout>
    <div class="bg-gray-200 shadow-sm sm:rounded-lg">
    ...
    <ul>
        ...
        <li class="p-4"><a href="/gestion-usuarios">Test 4 brach dev two</a></li>
        ...
        <li class="p-4"><a href="/soporte-comunicacion">Soporte y Comunicación</li>
    </ul>
